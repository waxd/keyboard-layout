...
#define BUILD_INFORMATION "waxd MacOS beta"
#endif
...
KEYMAPS(
  ...
  (___,              Key_F1,           Key_F2,        Key_F3,     Key_F4,        Key_F5,      Key_Delete,
   ___,              ___,              ___,        Key_mouseUp, Key_mouseBtnL, Key_mouseBtnR, ___,
   Key_LeftBracket,  Key_RightBracket, Key_mouseL, Key_mouseDn, Key_mouseR,    ___,
...
void setup() {
  ...
  StalkerEffect.variant = STALKER(Haunt, (CRGB(0, 123, 0)));
